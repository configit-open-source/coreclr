...
namespace System.Diagnostics.Tracing
{
    internal static class Statics
    {
        ...
        {
            MethodInfo result;
            result = declaringType.GetMethod(name, BindingFlags.DeclaredOnly | BindingFlags.Static | BindingFlags.NonPublic);
            return result;
        }
        ...
        public static TraceLoggingTypeInfo CreateDefaultTypeInfo(Type dataType, List<Type> recursionCheck)
        {
            ...
            if (eventAttrib != null || Statics.GetCustomAttribute<CompilerGeneratedAttribute>(dataType) != null || IsGenericMatch(dataType, typeof (KeyValuePair<, >)))
            {
