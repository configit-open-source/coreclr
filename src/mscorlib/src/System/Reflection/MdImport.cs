...
namespace System.Reflection
{
    ...
    internal struct MetadataToken
    {
        ...
        public bool IsTypeRef
        {
            get
            {
                return TokenType == MetadataTokenType.TypeRef;
            }
        }
        ...
        public bool IsTypeDef
        {
            get
            {
                return TokenType == MetadataTokenType.TypeDef;
            }
        }
        ...
        public bool IsFieldDef
        {
            get
            {
                return TokenType == MetadataTokenType.FieldDef;
            }
        }
        ...
        public bool IsMethodDef
        {
            get
            {
                return TokenType == MetadataTokenType.MethodDef;
            }
        }
        ...
        public bool IsMemberRef
        {
            get
            {
                return TokenType == MetadataTokenType.MemberRef;
            }
        }
        ...
        public bool IsEvent
        {
            get
            {
                return TokenType == MetadataTokenType.Event;
            }
        }
        ...
        public bool IsProperty
        {
            get
            {
                return TokenType == MetadataTokenType.Property;
            }
        }
        ...
        public bool IsParamDef
        {
            get
            {
                return TokenType == MetadataTokenType.ParamDef;
            }
        }
        ...
        public bool IsTypeSpec
        {
            get
            {
                return TokenType == MetadataTokenType.TypeSpec;
            }
        }
        ...
        public bool IsMethodSpec
        {
            get
            {
                return TokenType == MetadataTokenType.MethodSpec;
            }
        }
        ...
        public bool IsString
        {
            get
            {
                return TokenType == MetadataTokenType.String;
            }
        }
        ...
        public bool IsSignature
        {
            get
            {
                return TokenType == MetadataTokenType.Signature;
            }
        }
        ...
        public bool IsModule
        {
            get
            {
                return TokenType == MetadataTokenType.Module;
            }
        }
        ...
        public bool IsAssembly
        {
            get
            {
                return TokenType == MetadataTokenType.Assembly;
            }
        }
        ...
        public bool IsGenericPar
        {
            get
            {
                return TokenType == MetadataTokenType.GenericPar;
            }
        }
    ...
    internal struct MetadataImport
    {
        ...
        internal static void GetMarshalAs(ConstArray nativeType, out UnmanagedType unmanagedType, out VarEnum safeArraySubType, out string safeArrayUserDefinedSubType, out UnmanagedType arraySubType, out int sizeParamIndex, out int sizeConst, out string marshalType, out string marshalCookie, out int iidParamIndex)
        {
            ...
            _GetMarshalAs(nativeType.Signature, (int)nativeType.Length, out _unmanagedType, out _safeArraySubType, out safeArrayUserDefinedSubType, out _arraySubType, out sizeParamIndex, out sizeConst, out marshalType, out marshalCookie, out iidParamIndex);
