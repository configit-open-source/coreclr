...
namespace System
{
    public unsafe struct RuntimeTypeHandle : ISerializable
    {
        ...
        internal static bool IsPrimitive(RuntimeType type)
        {
            ...
            return (corElemType >= CorElementType.Boolean && corElemType <= CorElementType.R8) || corElemType == CorElementType.I || corElemType == CorElementType.U;
        }
        ...
        {
            CorElementType corElemType = GetCorElementType(type);
            return ((corElemType == CorElementType.Array || corElemType == CorElementType.SzArray) || (corElemType == CorElementType.Ptr) || (corElemType == CorElementType.ByRef));
        }
        ...
        private extern static void GetTypeByName(string name, bool throwOnError, bool ignoreCase, bool reflectionOnly, StackCrawlMarkHandle stackMark, IntPtr pPrivHostBinder, bool loadTypeFromPartialName, ObjectHandleOnStack type);
        ...
        internal static RuntimeType GetTypeByName(string name, bool throwOnError, bool ignoreCase, bool reflectionOnly, ref StackCrawlMark stackMark, IntPtr pPrivHostBinder, bool loadTypeFromPartialName)
        {
            ...
            GetTypeByName(name, throwOnError, ignoreCase, reflectionOnly, JitHelpers.GetStackCrawlMarkHandle(ref stackMark), pPrivHostBinder, loadTypeFromPartialName, JitHelpers.GetObjectHandleOnStack(ref type));
            return type;
        }
    ...
    public unsafe struct RuntimeMethodHandle : ISerializable
    {
        ...
        internal extern static bool IsCAVisibleFromDecoratedType(RuntimeTypeHandle attrTypeHandle, IRuntimeMethodInfo attrCtor, RuntimeTypeHandle sourceTypeHandle, RuntimeModule sourceModule);
        ...
        internal extern static void SerializationInvoke(IRuntimeMethodInfo method, Object target, SerializationInfo info, ref StreamingContext context);
    ...
    public unsafe struct ModuleHandle
    {
        ...
        private extern static void ResolveType(RuntimeModule module, int typeToken, IntPtr*typeInstArgs, int typeInstCount, IntPtr*methodInstArgs, int methodInstCount, ObjectHandleOnStack type);
        ...
        private extern static RuntimeMethodHandleInternal ResolveMethod(RuntimeModule module, int methodToken, IntPtr*typeInstArgs, int typeInstCount, IntPtr*methodInstArgs, int methodInstCount);
        ...
        private extern static void ResolveField(RuntimeModule module, int fieldToken, IntPtr*typeInstArgs, int typeInstCount, IntPtr*methodInstArgs, int methodInstCount, ObjectHandleOnStack retField);
